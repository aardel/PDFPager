  ...
  class jscanify {
    ...
    findPaperContour(img) {
      ...
      for (let i = 0; i < contours.size(); ++i) {
        // PATCHED (PDFPager): contours.get(i) allocates a Mat wrapper that
        // the upstream code never freed — at a few detections per second
        // this leaked the WASM heap and froze the page. Delete each one.
        const c = contours.get(i);
        let contourArea = cv.contourArea(c);
        c.delete();
